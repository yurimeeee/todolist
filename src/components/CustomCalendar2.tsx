...
// Example data of consecutive periods
const periods = [
  { start: '2024-08-20', end: '2024-08-22', title: 'Event A', color: 'blue' },
  { start: '2024-08-25', end: '2024-08-27', title: 'Event B', color: 'green' },
];
...
const CustomCalendar2 = ({ data }: CustomCalendarProps) => {
